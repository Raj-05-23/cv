...
<head>
    ...
    <style>
        body {
            ...
            background: radial-gradient(at top left, #e2e8f0, #f8fafc);
        ...
        .card {
            ...
            box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.05); /* More prominent shadow */
        ...
        .skill-tag {
            ...
            color: #1e40af;
            padding: 0.6rem 1.2rem; /* Slightly larger tags */
            border-radius: 9999px;
            font-weight: 600;
        ...
        .link-icon-group a:hover {
            color: #2563eb;
            transform: translateY(-2px); /* Lift icons on hover */
        }
        .profile-photo {
...
<body class="antialiased text-gray-800">
    ...
    <div class="container mx-auto px-4 py-10 max-w-4xl card my-10">
        ...
        <!-- Projects Section (Optional but highly recommended) -->
        <!-- <section class="mb-10">
